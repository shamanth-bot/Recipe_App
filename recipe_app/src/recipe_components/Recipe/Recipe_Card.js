...
render(){
        ...
        return (
            ...
            <div class={(this.props.SingleRecipe)?'col s2 m3 l4 offset-s3 offset-m4 offset-l4':"col s2 m3 l4"}>
                      ...
                      <tr style={{padding: "0px",margin:"0px",border:"none"}}>
                         ...
                         <td style= {{width:'60px'}} align='left' valign='middle'>
                           ...
                           <div style={{position:'relative',width:'50px',height:'50px',border:'0px',backgroundColor:'#ffffff',borderRadius:'50%'}}>
                             ...
                             <img src = {(this.props.cus_Details.profile_photo!==null)?`data:image/jpeg;base64,${this.props.cus_Details.profile_photo}`:(this.props.cus_Details.gender!==null&&this.props.cus_Details.gender!=='')?(this.props.cus_Details.gender.toString().toUpperCase()==='M')?'/images/profilePic_male.jpg':'/images/profile_female.jpg':'/images/profilePic_male.jpg'}  style={{border:'0',width:'50px',height:'50px',borderRadius:'50%',left:'0px',top:'0px',opacity:'1'}}></img>
                        ...
                        <span style={{fontWeight:'lighter',fontFamily:'verdana',fontSize:'20px',color:"#555555"}}>  {this.props.recipeDetails.author}</span>

                         </td>

                         <td align='right' valign='middle' style={{fontSize:'18px'}}>

                         <span><Link to={{pathname:`/Recipe_Details/${this.props.recipeDetails.author}`,state:{ recipe_data:this.props.recipeDetails,customerdetail:this.props.cus_Details,photos_list:this.props.recipeDetails.photos_list,name:this.props.recipeDetails.author,ingredients_list:this.props.recipeDetails.ingredients_list,direction_list:this.props.recipeDetails.directions_list,comments:this.props.recipeDetails.comments_List,user:this.props.user}}} >View</Link></span>
